# Module majestic-drawers

This library lets you declare one or more drawers, attach them to a host, and then open, close, toggle, add, or remove them through a controller.
